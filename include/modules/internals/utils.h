 ...
 */
SDK_EXPORT void sdk_utils_log(const IModule* module, LogType log_type, const char* message);
 ...
 */
SDK_EXPORT uint32_t sdk_utils_get_server_abi_version(const IModule* module);
